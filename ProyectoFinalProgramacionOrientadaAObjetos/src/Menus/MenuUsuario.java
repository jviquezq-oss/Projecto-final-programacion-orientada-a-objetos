...
import LogicaNegocio.AdministradorColaDeCanciones;
import LogicaNegocio.AdministradorListasDeReproduccion;
        ...
        do {
            ...
            switch (opcion) {
                ...
                case 7:
                    ...
                    break;
                default:
                    System.out.println("Seleccione una opción entre 1 y 7.");
            }
        } while(opcion != 7);
